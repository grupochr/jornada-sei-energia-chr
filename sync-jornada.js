/* === SYNC SEI/JORNADA - Firebase RTDB (sincronizacao aberta entre dispositivos) ===
   Espelha o estado local da Jornada (localStorage) no banco da SEI, para que
   PC, celular e qualquer aparelho vejam a mesma versao. */
(function(){
  var URL  = "https://sei-energia-330bb-default-rtdb.firebaseio.com/sei-jornada.json";
  var KEYS = ["jornada_"];
